...
hook.Add("KeyPress", "Spectate", function(ply, key)
    ...
    if key == IN_ATTACK --[[ or key == IN_ATTACK2]] then
        ...
        while ply:GetObserverTarget() == randomPly and #GAMEMODE.players > 1 and inTable(GAMEMODE.players, ply:GetObserverTarget()) and #player.GetAll() > 0 or randomPly:GetObserverMode() ~= OBS_MODE_NONE do
            randomPly = GAMEMODE.players[random(1, #GAMEMODE.players)]
        end
    end
